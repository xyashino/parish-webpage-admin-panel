...
import { RemoveGalleryModalBody } from "@components/modal-body/RemoveGalleryModalBody";
...
export const GalleryTableRow = ({ index, id, title, name }: Props) => {
  ...
  return (
    <>
      ...
      >
        <RemoveGalleryModalBody id={id} name={title} hideModal={hideModal} />
      </Modal>
    </>
  );
};
